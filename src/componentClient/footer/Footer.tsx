...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center bg-[#333] text-center text-white">
      <div className="container px-6 pt-6">
          ...
          <form>
            <div className="gird-cols-1 grid items-center justify-center gap-4 md:grid-cols-3">
              ...
              <div className="relative md:mb-6">
                <input
                  type="text"
                  className="peer border-2 border-solid border-[#ccc]  w-full rounded bg-transparent px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
                  id=""
        ...
        <div className="mb-6">
          <p>
            Chúng tôi cung cấp tải xuống miễn phí tất cả các sách PDF trên trang web của chúng tôi. Hơn nữa, bạn có thể đăng ký và tạo tài khoản! Hãy cho chúng tôi một cơ hội để thuyết phục bạn nếu bạn đang tìm
